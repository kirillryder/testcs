...
//---- Add custom methods to ImVec2/ImVec4 to maintain compatibility with older ImGui code
#define IM_VEC4_CLASS_EXTRA                                             \
        ImVec4(float scalar) { x = y = z = w = scalar; }               \
        float& operator[](size_t i) { return ((float*)this)[i]; }       \
        const float& operator[](size_t i) const { return ((const float*)this)[i]; }
